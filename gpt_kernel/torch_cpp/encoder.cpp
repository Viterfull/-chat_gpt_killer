...
EncoderImpl::EncoderImpl(int d_model, int ffn_hidden, int num_heads, float drop_prob,
...
torch::Tensor EncoderImpl::forward(torch::Tensor x, torch::Tensor self_attention_mask,
